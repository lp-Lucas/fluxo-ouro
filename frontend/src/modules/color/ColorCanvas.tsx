...
void main(){
  ...
  if (uChroma) {
    ...
    // alpha pela distância no plano UV à cor-chave. RAMPA CENTRADA em uSimilarity (tolerância =
    // ONDE fica a borda) com largura uSmoothness (suavidade = quão macia, simétrica). Antes a
